...
import { useToolRegistry } from '@/workbench/tools/registry'
type IconState = 'inactive' | 'active' | 'hover'
...
type ToolIconId = keyof typeof icons

function toolIcon(id: ToolIconId, state: IconState = 'inactive'): string {

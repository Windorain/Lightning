...
.wm-wfs__label { flex-shrink: 0; font-size: 11px; font-family: ui-monospace, 'Cascadia Code', monospace; color: var(--wb-text-muted); text-shadow: 0 1px 0 rgba(0, 0, 0, 0.4); min-width: 4.5em; text-align: right; }
</style>
